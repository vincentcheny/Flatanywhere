! function(t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.QRCode2 = e() : t.QRCode2 = e()
}(this, function() {
  return function(t) {
    function e(o) {
    ...
    ! function(t) {
      ...
      function u(t, e) {
        for (var r = 1, o = l(t), i = 0, n = v.length; i <= n; i++) {
          var a = 0;
          switch (e) {
            case g.L:
              a = v[i][0];
      ...
      e.prototype = {
        ...
        setupTypeInfo: function(t, e) {
          for (var r = this.errorCorrectLevel << 3 | e, o = c.getBCHTypeInfo(r), i = 0; i < 15; i++) {
            var n = !t && 1 == (o >> i & 1);
        ...
        for (var i = n.getRSBlocks(t, e), s = new a, h = 0; h < r.length; h++) {
          var u = r[h];
          s.put(u.mode, 4), s.put(u.getLength(), c.getLengthInBits(u.mode, t)), u.write(s)
        }
        for (var l = 0, h = 0; h < i.length; h++) l += i[h].dataCount;
        ...
        for (var r = 0, o = 0, n = 0, a = new Array(e.length), s = new Array(e.length), h = 0; h < e.length; h++) {
          ...
          for (var f = 0; f < a[h].length; f++) a[h][f] = 255 & t.buffer[f + r];
          r += u;
          var g = c.getErrorCorrectPolynomial(l),
            d = new i(a[h], g.getLength() - 1),
            p = d.mod(g);
        ...
        for (var _ = new Array(v), C = 0, f = 0; f < o; f++)
      ...
      for (var f = {
          ...
          getErrorCorrectPolynomial: function(t) {
            for (var e = new i([1], 0), r = 0; r < t; r++) e = e.multiply(new i([1, p.gexp(r)], 0));
            return e
          },
      ...
      for (var m = 8; m < 256; m++) p.EXP_TABLE[m] = p.EXP_TABLE[m - 4] ^ p.EXP_TABLE[m - 5] ^ p.EXP_TABLE[m - 6] ^ p.EXP_TABLE[m - 8];
      for (var m = 0; m < 255; m++) p.LOG_TABLE[p.EXP_TABLE[m]] = m;
      i.prototype = {
        get: function(t) {
          return this.num[t]
        },
        ...
        multiply: function(t) {
          for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
            for (var o = 0; o < t.getLength(); o++) e[r + o] ^= p.gexp(p.glog(this.get(r)) + p.glog(t.get(o)));
          return new i(e, 0)
        },
        mod: function(t) {
          if (this.getLength() - t.getLength() < 0) return this;
          for (var e = p.glog(this.get(0)) - p.glog(t.get(0)), r = new Array(this.getLength()), o = 0; o < this.getLength(); o++) r[o] = this.get(o);
          for (var o = 0; o < t.getLength(); o++) r[o] ^= p.gexp(p.glog(t.get(o)) + e);
        ...
        for (var o = r.length / 3, i = [], a = 0; a < o; a++)
          for (var s = r[3 * a + 0], h = r[3 * a + 1], u = r[3 * a + 2], l = 0; l < s; l++) i.push(new n(h, u));
        return i
      ...
      var v = [
        ...
        C = "svg" === document.documentElement.tagName.toLowerCase(),
        A = C ? _ : s() ? function(t) {
          function e() {
          ...
          if (t._android && t._android <= 2.1) {
            var o = 1 / window.devicePixelRatio,
              i = CanvasRenderingContext2D.prototype.drawImage;
            CanvasRenderingContext2D.prototype.drawImage = function(t, e, r, n, a, s, h, u, l) {
              if ("nodeName" in t && /img/i.test(t.nodeName))
                for (var f = arguments.length - 1; f >= 1; f--) arguments[f] = arguments[f] * o;
              else "undefined" == typeof u && (arguments[1] *= o, arguments[2] *= o, arguments[3] *= o, arguments[4] *= o);
              i.apply(this, arguments)
            }
          }
          var n = function(t, e) {
            this._bIsPainted = !1, this._android = h(), this._htOption = e, this._elCanvas = document.createElement("canvas"), this._elCanvas.width = e.width, this._elCanvas.height = e.height, t.appendChild(this._elCanvas), this._el = t, this._oContext = this._elCanvas.getContext("2d"), this._bIsPainted = !1, this._elImage = document.createElement("img"), this._elImage.alt = "Scan me!", this._elImage.style.display = "none", this._el.appendChild(this._elImage), this._bSupportDataURI = null
          };
      ...
      r = function(t, e) {
        ...
        "string" == typeof t && (t = document.getElementById(t)), this._htOption.useSVG && (A = _), this._android = h(), this._el = t, this._oQRCode = null, this._oDrawing = new A(this._el, this._htOption), this._htOption.text && this.makeCode(this._htOption.text)
      }, r.prototype.makeCode = function(t) {
        this._oQRCode = new o(u(t, this._htOption.correctLevel), this._htOption.correctLevel), this._oQRCode.addData(t), this._oQRCode.make(), this._el.title = t, this._oDrawing.draw(this._oQRCode), this.makeImage()
