function addLock(type, nickname, num, price, SLID, address, isShown, st, et) {
    ...
    var $card_content = $('<div><span><p></p><a><i>lock_open</i></a></span><div class="card-action"><p><span></span><span></span></p></div></div>');
